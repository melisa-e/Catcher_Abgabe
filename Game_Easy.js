...
var oneStar = 10                            // Punktestand ab dem man einen Stern für das Rating bekommt
var twoStars = 20                           // Punktestand ab dem man zwei Sterne für das Rating bekommt
var threeStars = 30                         // Punktestand ab dem man drei Sterne für das Rating bekommt
...
class Game_Easy extends Phaser.Scene {
    ...
    */
    ...
    create() {
        ...
        **/ 
        var amountStone = Math.round((this.cameras.main.height * 0.9)/distanceStone);
        stones = [];
